...
export function Sidebar({
  ...
  return (
    ...
    >
      {/* Brand Header */}
      <div className={`flex items-center justify-between p-5 border-b transition-colors duration-350
      ...
      <div className="flex-1 overflow-y-auto overflow-x-hidden p-4 space-y-6">
        ...
        <div className="space-y-3">
          ...
          <div className="relative">
            <Search className={`absolute left-3 top-2.5 w-4.5 h-4.5 ${isDark ? "text-sky-500/40" : "text-sky-600/40"}`} />
            <input
              type="text"
        ...
        <div className="space-y-3 pb-3">
          ...
          <div className={`space-y-2 transition-all duration-300 ${fadeState ? "opacity-100 scale-100" : "opacity-0 scale-98"}`}>
            {catalysts.map((ex, idx) => (
              ...
              >
                <div className="flex items-center justify-between w-full">
                  ...
                  <span className={`inline-flex items-center gap-0.5 px-1 py-0.2 text-[8px] font-mono uppercase rounded border
